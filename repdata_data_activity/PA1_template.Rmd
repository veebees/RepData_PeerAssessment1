...
plot(actvty1_2$interval, actvty1_2$avg.steps, type = "l", xlab = "Average Steps", ylab = "Interval")
```
...
#Aggregating steps as per dates
actvty1_4_wdy_a<-aggregate(actvty1_4_wdy$steps, by = list(actvty1_4_wdy$interval), FUN = mean)
actvty1_4_wnd_a<-aggregate(actvty1_4_wnd$steps, by = list(actvty1_4_wnd$interval), FUN = mean)
